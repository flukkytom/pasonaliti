...
<title>Olutola Michael Obembe  |  DISC - Personality Style Survey - the Assessment</title>
...
<li id="menu-item-443" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-71  menu-item-443"><a href="http://www.olutolaobembe.com/my-projects/">Projects</a></li>
    	...
    	<div class="page col-full">
			...
			<section id="main" class="fullwidth">
	                ...
	                <article class="post-71 page type-page status-publish hentry">
						...
						<header>
							<h1>DISC - Personality Style Survey - the Assessment</h1>
						</header>
	                    
	                    <section class="entry">
<body>

<form action="result.php" method="post" enctype="multipart/form-data" name="dISC" id="dISC">
<table width="70%" border="0">
  <tr>
    <td><div>
      <div align="center"><img src="http://www.olutolaobembe.com/wp-content/uploads/2013/09/dimages.jpg" alt="disc-assessment" width="573" height="81" longdesc="http://olutolaobembe.com" /></div>
    </div></td>
  </tr>
</table>
<div>DESCRIPTION: Choose a word on each row below that best describes you. <br />NOTE: Remember, Choose who you are now not who you want/wish to be</div>
<table width="72%" border="0" cellpadding="5" cellspacing="0">
  <tr><td><div class="divv">

<table width="100%" border="0" cellpadding="5" cellspacing="0">
  <tr>
    <td bgcolor="#FF9900">&nbsp;</td>
    <td bgcolor="#FF9900"><span class="style7">A</span></td>
    <td bgcolor="#FF9900"><span class="style7">B</span></td>
    <td bgcolor="#FF9900"><span class="style7">C</span></td>
    <td bgcolor="#FF9900"><span class="style7">D</span></td>
  </tr>
  <tr>
    ...
    <td>
      <span class="style3">
    <label>
        <input name="i1" type="radio" value="a" />
      </label>
    Restrained</span></td>
    <td><span class="style3">
      <input name="i1" type="radio" value="b" />
    Forceful</span></td>
    <td><span class="style3">
      <input name="i1" type="radio" value="c" />
    Careful</span></td>
    <td><span class="style3">
      <input name="i1" type="radio" value="d" />
    Expressive</span></td>
  </tr>
  <tr>
    ...
    <td><span class="style3">
      <label>
      <input name="i2" type="radio" value="a" />
      </label>
      Pioneering</span></td>
    <td><span class="style3">
      <input name="i2" type="radio" value="b" />
      Correct</span></td>
    <td><span class="style3">
      <input name="i2" type="radio" value="c" />
      Exciting</span></td>
    <td><span class="style3">
      <input name="i2" type="radio" value="d" />
      Satisfied</span></td>
  </tr>
  <tr>
    ...
    <td><span class="style3">
      <label>
      <input name="i3" type="radio" value="a" />
      </label>
      Willing</span></td>
    <td><span class="style3">
      <input name="i3" type="radio" value="b" />
      Animated</span></td>
    <td><span class="style3">
      <input name="i3" type="radio" value="c" />
      Bold</span></td>
    <td><span class="style3">
      <input name="i3" type="radio" value="d" />
      Precise</span></td>
  </tr>
  <tr>
    ...
    <td><span class="style3">
      <label>
      <input name="i4" type="radio" value="a" />
      </label>
      Argumentative</span></td>
    <td><span class="style3">
      <input name="i4" type="radio" value="b" />
      Doubting</span></td>
    <td><span class="style3">
      <input name="i4" type="radio" value="c" />
      Indecisive</span></td>
    <td><span class="style3">
      <input name="i4" type="radio" value="d" />
      Unpredictable</span></td>
  </tr>
  <tr>
    <td><span class="style3">5</span></td>
    <td><span class="style3">
      <label>
      <input name="i5" type="radio" value="a" />
      </label>
      Respectful</span></td>
    <td><span class="style3">
      <input name="i5" type="radio" value="b" />
      Outgoing</span></td>
    <td><span class="style3">
      <input name="i5" type="radio" value="c" />
      Patient</span></td>
    <td><span class="style3">
      <input name="i5" type="radio" value="d" />
      Daring</span></td>
  </tr>
  <tr>
    ...
    <td><span class="style3">
      <label>
      <input name="i6" type="radio" value="a" />
      </label>
      Persuasive</span></td>
    <td><span class="style3">
      <input name="i6" type="radio" value="b" />
      Self-reliant</span></td>
    <td><span class="style3">
      <input name="i6" type="radio" value="c" />
      Logical</span></td>
    <td><span class="style3">
      <input name="i6" type="radio" value="d" />
      Gentle</span></td>
  </tr>
  
  <tr>
    <td><span class="style3">7</span></td>
    <td><span class="style3">
      <label>
      <input name="i7" type="radio" value="a" />
      </label>
      Cautious</span></td>
    <td><span class="style3">
      <input name="i7" type="radio" value="b" />
      Even-Tempered</span></td>
    <td><span class="style3">
      <input name="i7" type="radio" value="c" />
      Decisive</span></td>
    <td><span class="style3">
      <input name="i7" type="radio" value="d" />
      Life of the Party </span></td>
  </tr>
  <tr>
    <td><span class="style3">8</span></td>
    <td><span class="style3">
      <label>
      <input name="i8" type="radio" value="a" />
      </label>
      Popular</span></td>
    <td><span class="style3">
      <input name="i8" type="radio" value="b" />
      Assertive</span></td>
    <td><span class="style3">
      <input name="i8" type="radio" value="c" />
      Perfectionist</span></td>
    <td><span class="style3">
      <input name="i8" type="radio" value="d" />
      Generous</span></td>
  </tr>
  <tr>
    ...
    <td><span class="style3">
      <label>
      <input name="i9" type="radio" value="a" />
      </label>
      Colorful</span></td>
    <td><span class="style3">
      <input name="i9" type="radio" value="b" />
      Modest</span></td>
    <td><span class="style3">
      <input name="i9" type="radio" value="c" />
      Easy-going</span></td>
    <td><span class="style3">
      <input name="i9" type="radio" value="d" />
      Unyeilding</span></td>
  </tr>
  <tr>
    ...
    <td><span class="style3">
      <label>
      <input name="i10" type="radio" value="a" />
      </label>
      Systematic</span></td>
    <td><span class="style3">
      <input name="i10" type="radio" value="b" />
      Optimistic</span></td>
    <td><span class="style3">
      <input name="i10" type="radio" value="c" />
      Persistent</span></td>
    <td><span class="style3">
      <input name="i10" type="radio" value="d" />
      Accomodating</span></td>
  </tr>
  <tr>
    <td><span class="style3">11</span></td>
    <td><span class="style3">
      <label>
      <input name="i11" type="radio" value="a" />
      </label>
      Relentless</span></td>
    <td><span class="style3">
      <input name="i11" type="radio" value="b" />
      Humble</span></td>
    <td><span class="style3">
      <input name="i11" type="radio" value="c" />
      Neighborly</span></td>
    <td><span class="style3">
      <input name="i11" type="radio" value="d" />
      Talkative</span></td>
  </tr>
  ...
  <tr>
    ...
    <td><span class="style3">
      <label>
      <input name="i12" type="radio" value="a" />
      </label>
      Friendly</span></td>
    <td><span class="style3">
      <input name="i12" type="radio" value="b" />
      Observant</span></td>
    <td><span class="style3">
      <input name="i12" type="radio" value="c" />
      Playful</span></td>
    <td><span class="style3">
      <input name="i12" type="radio" value="d" />
      Strong-willed</span></td>
  </tr>
  <tr>
    <td><span class="style3">13</span></td>
    <td><span class="style3">
      <label>
      <input name="i13" type="radio" value="a" />
      </label>
      Charming</span></td>
    <td><span class="style3">
      <input name="i13" type="radio" value="b" />
      Adventurous</span></td>
    <td><span class="style3">
      <input name="i13" type="radio" value="c" />
      Disciplined</span></td>
    <td><span class="style3">
      <input name="i13" type="radio" value="d" />
      Deliberate</span></td>
  </tr>
  <tr>
    <td><span class="style3">14</span></td>
    <td><span class="style3">
      <label>
      <input name="i14" type="radio" value="a" />
      </label>
      Restrained</span></td>
    <td><span class="style3">
      <input name="i14" type="radio" value="b" />
      Steady</span></td>
    <td><span class="style3">
      <input name="i14" type="radio" value="c" />
      Aggressive</span></td>
    <td><span class="style3">
      <input name="i14" type="radio" value="d" />
      Attractive</span></td>
  </tr>
  <tr>
    ...
    <td><span class="style3">
      <label>
      <input name="i15" type="radio" value="a" />
      </label>
      Ethusiastic</span></td>
    <td><span class="style3">
      <input name="i15" type="radio" value="b" />
      Analytical</span></td>
    <td><span class="style3">
      <input name="i15" type="radio" value="c" />
      Sympathetic</span></td>
    <td><span class="style3">
      <input name="i15" type="radio" value="d" />
      Determined</span></td>
  </tr>
  <tr>
    <td><span class="style3">16</span></td>
    <td><span class="style3">
      <label>
      <input name="i16" type="radio" value="a" />
      </label>
      Commanding</span></td>
    <td><span class="style3">
      <input name="i16" type="radio" value="b" />
      Impulsive</span></td>
    <td><span class="style3">
      <input name="i16" type="radio" value="c" />
      Slow-paced</span></td>
    <td><span class="style3">
      <input name="i16" type="radio" value="d" />
      Critical</span></td>
  </tr>
  ...
  <tr>
    ...
    <td><span class="style3">
      <label>
      <input name="i17" type="radio" value="a" />
      </label>
      Consistent</span></td>
    <td><span class="style3">
      <input name="i17" type="radio" value="b" />
      Force of Character </span></td>
    <td><span class="style3">
      <input name="i17" type="radio" value="c" />
      Lively</span></td>
    <td><span class="style3">
      <input name="i17" type="radio" value="d" />
      Laid-back</span></td>
  </tr>
  <tr>
    ...
    <td><span class="style3">
      <label>
      <input name="i18" type="radio" value="a" />
      </label>
      Influential</span></td>
    <td><span class="style3">
      <input name="i18" type="radio" value="b" />
      Kind</span></td>
    <td><span class="style3">
      <input name="i18" type="radio" value="c" />
      Independent</span></td>
    <td><span class="style3">
      <input name="i18" type="radio" value="d" />
      Orderly</span></td>
  </tr>
  <tr>
    ...
    <td><span class="style3">
      <label>
      <input name="i19" type="radio" value="a" />
      </label>
      Idealistic</span></td>
    <td><span class="style3">
      <input name="i19" type="radio" value="b" />
      Popular</span></td>
    <td><span class="style3">
      <input name="i19" type="radio" value="c" />
      Pleasant</span></td>
    <td><span class="style3">
      <input name="i19" type="radio" value="d" />
      Out-Spoken</span></td>
  </tr>
  <tr>
    ...
    <td><span class="style3">
      <label>
      <input name="i20" type="radio" value="a" />
      </label>
      Impatient</span></td>
    <td><span class="style3">
      <input name="i20" type="radio" value="b" />
      Serious</span></td>
    <td><span class="style3">
      <input name="i20" type="radio" value="c" />
      Procastinator</span></td>
    <td><span class="style3">
      <input name="i20" type="radio" value="d" />
      Emotional</span></td>
  </tr>
  <tr>
    ...
    <td><span class="style3">
      <label>
      <input name="i21" type="radio" value="a" />
      </label>
      Competitive</span></td>
    <td><span class="style3">
      <input name="i21" type="radio" value="b" />
      Spontaneous</span></td>
    <td><span class="style3">
      <input name="i21" type="radio" value="c" />
      Loyal</span></td>
    <td><span class="style3">
      <input name="i21" type="radio" value="d" />
      Thoughful</span></td>
  </tr>
  <tr>
    ...
    <td><span class="style3">
      <label>
      <input name="i22" type="radio" value="a" />
      </label>
      Self-Sacrificing</span></td>
    <td><span class="style3">
      <input name="i22" type="radio" value="b" />
      Considerate</span></td>
    <td><span class="style3">
      <input name="i22" type="radio" value="c" />
      Convincing</span></td>
    <td><span class="style3">
      <input name="i22" type="radio" value="d" />
      Courageous</span></td>
  </tr>
  
  <tr>
    <td><span class="style3">23</span></td>
    <td><span class="style3">
      <label>
      <input name="i23" type="radio" value="a" />
      </label>
      Dependent</span></td>
    <td><span class="style3">
      <input name="i23" type="radio" value="b" />
      Flightly</span></td>
    <td><span class="style3">
      <input name="i23" type="radio" value="c" />
      Stoic</span></td>
    <td><span class="style3">
      <input name="i23" type="radio" value="d" />
      Pushy</span></td>
  </tr>
  <tr>
    <td><span class="style3">24</span></td>
    <td><span class="style3">
      <label>
      <input name="i24" type="radio" value="a" />
      Tolerant</label>
    </span></td>
    <td><span class="style3">
      <input name="i24" type="radio" value="b" />
      Conventional</span></td>
    <td><span class="style3">
      <input name="i24" type="radio" value="c" />
      Stimulating</span></td>
    <td><span class="style3">
      <input name="i24" type="radio" value="d" />
      Directing</span></td>
  </tr>
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan="4"><label>
      <input name="disc_1" type="submit" class="style7" id="disc_1" value="Get My Test Score" />
    </label></td>
    </tr>
</table>
</div>

...
if (isset($_POST['disc_1']))	{
	$test=calculate_disc();
	$result=displayresult($test);
}
...
<br />
<div class="style3">
  <p>Hi, Here is your DISC Assessment result. Your primary behavioral trait according to this dISC Test says you are </p>
</div>
<div>
  <p class="style1" > <?php echo $result[1]." = " ; ?><?php echo $result[0]; ?> </p>
</div>
<div class="style3">Read more about your Personality Traits here: <a href="https://www.discinsights.com/personality-style-<?php echo strtolower($result[1]);?>" target="_blank"><? echo "The " . $result[0]. " style knowledge sheet"?></a></div>
<div>
  <p class="style1" > Full Result Display</p>
  <p class="style3" > Dominance (D)= <?php echo $test[0]; ?></p>
  <p class="style3" > Influence (I)= <?php echo $test[1]; ?></p>
  <p class="style3" > Steady (S)= <?php echo $test[2]; ?></p>
  <p class="style3" > Compliant (C)= <?php echo $test[3]; ?></p>
</div>


<form action="endshow.php" method="post" enctype="multipart/form-data" name="disc_result" class="style3" id="disc_result">
  <div>
    <p class="style1">Send Me my Full Result: I would like to have a copy</p>
    <p>Email Address: 
      <label>
      <input name="email" type="text" id="email" value="" />
      </label>
      <label>
      <input name="send-me" type="submit" class="style3" id="send-me" value="Send Me" />
      </label>
    </p>
  </div>
</form>
